...
;(function (doc) {
  ...
  var onLoad = function onLoad() {
    ...
    $listAccordions().forEach(function (accordion_node, index) {
      ...
      var accordionClassName = accordion_node.hasAttribute(ACCORDION_DATA_PREFIX_CLASS) === true ? accordion_node.getAttribute(ACCORDION_DATA_PREFIX_CLASS) : '';
      var multiSelectableAttribute = accordion_node.hasAttribute(ACCORDION_DATA_MULTISELECTABLE) === true ? accordion_node.getAttribute(ACCORDION_DATA_MULTISELECTABLE) : '';
    ...
    ['click', 'keydown', 'focus'].forEach(function (eventName) {
      ...
      doc.body.addEventListener(eventName, function (e) {
        ...
        if (hasClass(e.target, ACCORDION_JS_HEADER) === true && eventName === 'click') {
          (function () {
            ...
            if (accordionMultiSelectable === 'false') {
              $accordionAllHeaders.forEach(function (header_node, index) {
        ...
        if (id_panel !== '' && eventName === 'keydown') {
          (function () {
            //console.log('yes in pabnelk' + e.keyCode);
