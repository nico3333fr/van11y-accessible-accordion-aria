...
/*  const triggerEvent = (el, event_type) => {
  ...
  const selectHeaderInList = (elts, param) => {
        ...
        if ( param === 'next' ){
            ...
            setTimeout(function(){ elts[indice_trouve+1].focus(); }, 0);
            }
        if ( param === 'prev' ){
            selectHeader ( elts[indice_trouve-1] );
            setTimeout(function(){ elts[indice_trouve-1].focus(); }, 0);
       ...
       doc.body
          .addEventListener(eventName, e => {
             ...
             if ( hasClass( e.target, ACCORDION_JS_HEADER) === true && eventName === 'click' ) {
                ...
                setTimeout(function(){ buttonTag.focus(); }, 0);
                e.preventDefault();
                ...
                if ( hasClass( e.target, ACCORDION_JS_HEADER) === true && eventName === 'keydown' ) {
                    ...
                    if ( e.keyCode === 36 ) {
                       ...
                       setTimeout(function(){ $accordionAllHeaders[0].focus(); }, 0);
                       e.preventDefault();
                       }
                    // strike end on the tab => last tab
                            ...
                            setTimeout(function(){ $accordionAllHeaders[ $accordionAllHeaders.length-1 ].focus(); }, 0);
                            e.preventDefault();
                           }
